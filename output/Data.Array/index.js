...
var unzip = $foreign["uncons'"](function (_365) {
    return new Data_Tuple.Tuple([  ], [  ]);
})(function (_366) {
    return function (ts) {
        var _670 = unzip(ts);
        return new Data_Tuple.Tuple($colon(_366.value0)(_670.value0), $colon(_366.value1)(_670.value1));
    };
});
...
var tail = $foreign["uncons'"](Prelude["const"](Data_Maybe.Nothing.value))(function (_363) {
    return function (xs) {
...
var span = function (p) {
    var go = function (__copy_acc) {
        return function (__copy_xs) {
            ...
            tco: while (true) {
                var _676 = uncons(xs);
                if (_676 instanceof Data_Maybe.Just && p(_676.value0.head)) {
                    var __tco_acc = $colon(_676.value0.head)(acc);
                    acc = __tco_acc;
                    xs = _676.value0.tail;
                    continue tco;
                };
...
var sortBy = function (comp) {
    return function (xs) {
        var comp$prime = function (x) {
            return function (y) {
                var _680 = comp(x)(y);
                if (_680 instanceof Prelude.GT) {
                    return 1;
                };
                if (_680 instanceof Prelude.EQ) {
                    return 0;
                };
                if (_680 instanceof Prelude.LT) {
                    return Prelude.negate(Prelude.ringInt)(1);
                };
                throw new Error("Failed pattern match at /Users/beckyconning/Documents/purescript-pantry/bower_components/purescript-arrays/src/Data/Array.purs line 390, column 3 - line 395, column 1: " + [ _680.constructor.name ]);
            };
        };
...
var replicateM = function (__dict_Monad_2) {
    return function (n) {
        return function (m) {
            ...
            throw new Error("Failed pattern match at /Users/beckyconning/Documents/purescript-pantry/bower_components/purescript-arrays/src/Data/Array.purs line 117, column 1 - line 118, column 1: " + [ n.constructor.name, m.constructor.name ]);
        };
    };
};
...
var nubBy = function (eq) {
    return function (_368) {
        ...
        var _685 = uncons(_368);
        if (_685 instanceof Data_Maybe.Just) {
            return $colon(_685.value0.head)(nubBy(eq)($foreign.filter(function (y) {
                return Prelude.not(Prelude.booleanAlgebraBoolean)(eq(_685.value0.head)(y));
            })(_685.value0.tail)));
        };
        throw new Error("Failed pattern match: " + [ _685.constructor.name ]);
    };
};
...
var some = function (__dict_Alternative_4) {
    return function (__dict_Lazy_5) {
        return function (v) {
            return Prelude["<*>"]((__dict_Alternative_4["__superclass_Prelude.Applicative_0"]())["__superclass_Prelude.Apply_0"]())(Prelude["<$>"](((__dict_Alternative_4["__superclass_Control.Plus.Plus_1"]())["__superclass_Control.Alt.Alt_0"]())["__superclass_Prelude.Functor_0"]())($colon)(v))(Control_Lazy.defer(__dict_Lazy_5)(function (_361) {
...
var init = function (xs) {
    ...
    throw new Error("Failed pattern match at /Users/beckyconning/Documents/purescript-pantry/bower_components/purescript-arrays/src/Data/Array.purs line 207, column 1 - line 208, column 1: " + [ xs.constructor.name ]);
};
    ...
    var go = function (__copy_acc) {
        return function (__copy__370) {
            ...
            tco: while (true) {
                ...
                var _692 = uncons(_370);
                if (_692 instanceof Data_Maybe.Just) {
                    var sp = span(op(_692.value0.head))(_692.value0.tail);
                    var __tco_acc = $colon($colon(_692.value0.head)(sp.init))(acc);
                    acc = __tco_acc;
                    _370 = sp.rest;
                    continue tco;
                };
                throw new Error("Failed pattern match at /Users/beckyconning/Documents/purescript-pantry/bower_components/purescript-arrays/src/Data/Array.purs line 457, column 1 - line 458, column 1: " + [ _692.constructor.name ]);
            };
        };
    };
    return go([  ]);
...
var foldM = function (__dict_Monad_10) {
    return function (f) {
        return function (a) {
            return $foreign["uncons'"](function (_367) {
...
var insertBy = function (cmp) {
    return function (x) {
        return function (ys) {
            var i = Data_Maybe.maybe(0)(function (_9) {
                return Prelude["+"](Prelude.semiringInt)(_9)(1);
...
var filterM = function (__dict_Monad_13) {
    return function (p) {
        return $foreign["uncons'"](function (_364) {
            return Prelude.pure(__dict_Monad_13["__superclass_Prelude.Applicative_0"]())([  ]);
        })(function (x) {
            return function (xs) {
                return Prelude.bind(__dict_Monad_13["__superclass_Prelude.Bind_1"]())(p(x))(function (_22) {
                    return Prelude.bind(__dict_Monad_13["__superclass_Prelude.Bind_1"]())(filterM(__dict_Monad_13)(p)(xs))(function (_21) {
...
var elemLastIndex = function (__dict_Eq_14) {
    return function (x) {
        return findLastIndex(function (_11) {
            return Prelude["=="](__dict_Eq_14)(_11)(x);
        });
    };
};
var elemIndex = function (__dict_Eq_15) {
    return function (x) {
        return findIndex(function (_10) {
            return Prelude["=="](__dict_Eq_15)(_10)(x);
        });
    };
};
...
var deleteBy = function (eq) {
    return function (x) {
        return function (_369) {
            ...
            return Data_Maybe.maybe(_369)(function (i) {
                return Data_Maybe_Unsafe.fromJust(deleteAt(i)(_369));
            })(findIndex(eq(x))(_369));
        };
    };
};
        ...
        return function (xs) {
            var go = function (x) {
                ...
                if (_704 instanceof Data_Maybe.Just) {
                    return updateAt(i)(_704.value0)(xs);
                };
                throw new Error("Failed pattern match at /Users/beckyconning/Documents/purescript-pantry/bower_components/purescript-arrays/src/Data/Array.purs line 330, column 3 - line 339, column 1: " + [ _704.constructor.name ]);
            };
            return Data_Maybe.maybe(Data_Maybe.Nothing.value)(go)($bang$bang(xs)(i));
        };
    };
