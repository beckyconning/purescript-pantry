...
var uncons = function (_269) {
    if (_269 === "") {
        return Data_Maybe.Nothing.value;
    };
    return new Data_Maybe.Just({
        head: Data_String_Unsafe.charAt(Prelude.zero(Prelude.semiringInt))(_269), 
        tail: $foreign.drop(Prelude.one(Prelude.semiringInt))(_269)
    });
};
...
var stripSuffix = function (suffix) {
    return function (str) {
        var _662 = lastIndexOf(suffix)(str);
        if (_662 instanceof Data_Maybe.Just && Prelude["=="](Prelude.eqInt)(_662.value0)(Prelude["-"](Prelude.ringInt)($foreign.length(str))($foreign.length(suffix)))) {
            return Data_Maybe.Just.create($foreign.take(_662.value0)(str));
        };
        return Data_Maybe.Nothing.value;
    };
};
...
var stripPrefix = function (prefix) {
    return function (str) {
        var _664 = indexOf(prefix)(str);
        if (_664 instanceof Data_Maybe.Just && _664.value0 === 0) {
