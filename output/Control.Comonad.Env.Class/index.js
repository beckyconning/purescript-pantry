...
var comonadEnvTuple = new ComonadEnv(function () {
    ...
    return function (_116) {
        return new Data_Tuple.Tuple(f(_116.value0), _116.value1);
    };
});
    ...
    return new ComonadEnv(function () {
        ...
        return function (x) {
            return Control_Comonad_Env_Trans.EnvT((function () {
                var _241 = Control_Comonad_Env_Trans.runEnvT(x);
                return new Data_Tuple.Tuple(f(_241.value0), _241.value1);
            })());
        };
    });
};
