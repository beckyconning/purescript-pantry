...
var showUnit = new Show(function (_90) {
    return "unit";
});
...
var showOrdering = new Show(function (_91) {
    ...
    throw new Error("Failed pattern match at /Users/beckyconning/Documents/purescript-pantry/bower_components/purescript-prelude/src/Prelude.purs line 851, column 1 - line 856, column 1: " + [ _91.constructor.name ]);
});
...
var showBoolean = new Show(function (_89) {
    ...
    throw new Error("Failed pattern match at /Users/beckyconning/Documents/purescript-pantry/bower_components/purescript-prelude/src/Prelude.purs line 829, column 1 - line 833, column 1: " + [ _89.constructor.name ]);
});
...
var semiringUnit = new Semiring(function (_62) {
    return function (_63) {
        return unit;
    };
}, function (_64) {
...
var semigroupOrdering = new Semigroup(function (_61) {
    return function (y) {
        ...
        throw new Error("Failed pattern match at /Users/beckyconning/Documents/purescript-pantry/bower_components/purescript-prelude/src/Prelude.purs line 413, column 1 - line 418, column 1: " + [ _61.constructor.name, y.constructor.name ]);
    };
});
...
var eqUnit = new Eq(function (_74) {
    return function (_75) {
        return true;
    };
});
...
var eqOrdering = new Eq(function (_76) {
    return function (_77) {
        if (_76 instanceof LT && _77 instanceof LT) {
            return true;
        };
        if (_76 instanceof GT && _77 instanceof GT) {
            return true;
        };
        if (_76 instanceof EQ && _77 instanceof EQ) {
            return true;
        };
        return false;
    };
...
var ordOrdering = new Ord(function () {
    ...
    return function (_81) {
        if (_80 instanceof LT && _81 instanceof LT) {
            return EQ.value;
        };
        if (_80 instanceof EQ && _81 instanceof EQ) {
            return EQ.value;
        };
        if (_80 instanceof GT && _81 instanceof GT) {
            return EQ.value;
        };
        if (_80 instanceof LT) {
            return LT.value;
        };
        if (_80 instanceof EQ && _81 instanceof LT) {
            return GT.value;
        };
        if (_80 instanceof EQ && _81 instanceof GT) {
            return LT.value;
        };
        if (_80 instanceof GT) {
            return GT.value;
        };
        throw new Error("Failed pattern match at /Users/beckyconning/Documents/purescript-pantry/bower_components/purescript-prelude/src/Prelude.purs line 668, column 1 - line 677, column 1: " + [ _80.constructor.name, _81.constructor.name ]);
    };
});
    ...
    return new Ord(function () {
        ...
        return function (ys) {
            return $dollar(compare(ordInt)(0))($foreign.ordArrayImpl(function (x) {
                return function (y) {
                    var _609 = compare(__dict_Ord_16)(x)(y);
                    if (_609 instanceof EQ) {
                        return 0;
                    };
                    if (_609 instanceof LT) {
                        return 1;
                    };
                    if (_609 instanceof GT) {
                        return negate(ringInt)(1);
                    };
                    throw new Error("Failed pattern match at /Users/beckyconning/Documents/purescript-pantry/bower_components/purescript-prelude/src/Prelude.purs line 660, column 1 - line 666, column 1: " + [ _609.constructor.name ]);
                };
            })(xs)(ys));
        };
    });
...
var $less = function (__dict_Ord_17) {
    return function (a1) {
        return function (a2) {
            var _610 = compare(__dict_Ord_17)(a1)(a2);
            if (_610 instanceof LT) {
                return true;
            };
            return false;
        };
...
var $less$eq = function (__dict_Ord_18) {
    return function (a1) {
        return function (a2) {
            var _611 = compare(__dict_Ord_18)(a1)(a2);
            if (_611 instanceof GT) {
                return false;
            };
            return true;
        };
...
var $greater = function (__dict_Ord_19) {
    return function (a1) {
        return function (a2) {
            var _612 = compare(__dict_Ord_19)(a1)(a2);
            if (_612 instanceof GT) {
                return true;
            };
            return false;
        };
...
var $greater$eq = function (__dict_Ord_20) {
    return function (a1) {
        return function (a2) {
            var _613 = compare(__dict_Ord_20)(a1)(a2);
            if (_613 instanceof LT) {
                return false;
            };
            return true;
        };
...
var boundedFn = function (__dict_Bounded_21) {
    return new Bounded(function (_83) {
