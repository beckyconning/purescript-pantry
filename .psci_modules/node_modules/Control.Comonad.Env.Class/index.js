...
var comonadEnvTuple = new ComonadEnv(function () {
    ...
    return function (_300) {
        return new Data_Tuple.Tuple(f(_300.value0), _300.value1);
    };
});
    ...
    return new ComonadEnv(function () {
        ...
        return function (x) {
            return Control_Comonad_Env_Trans.EnvT((function () {
                var _644 = Control_Comonad_Env_Trans.runEnvT(x);
                return new Data_Tuple.Tuple(f(_644.value0), _644.value1);
            })());
        };
    });
};
