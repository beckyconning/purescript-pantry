        ...
        return function (t) {
            return function (f) {
                return Prelude[">>="](__dict_Bind_4)(cond)(function (cond$prime) {
                    ...
                    throw new Error("Failed pattern match at bower_components/purescript-control/src/Control/Bind.purs line 44, column 1 - line 45, column 1: " + [ cond$prime.constructor.name ]);
                });
            };
        };
    };
