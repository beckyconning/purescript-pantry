        ...
        return mapErrorT(function (m) {
            return pass(Prelude.bind(__dict_Monad_10["__superclass_Prelude.Bind_1"]())(m)(function (_36) {
                return Prelude["return"](__dict_Monad_10["__superclass_Prelude.Applicative_0"]())((function () {
                    ...
                    throw new Error("Failed pattern match at bower_components/purescript-transformers/src/Control/Monad/Error/Trans.purs line 87, column 1 - line 88, column 1: " + [ _36.constructor.name ]);
                })());
            }));
        });
    };
...
var applyErrorT = function (__dict_Apply_14) {
    return new Prelude.Apply(function () {
        ...
        return function (_315) {
            return ErrorT(Prelude["<*>"](__dict_Apply_14)(Prelude["<$>"](__dict_Apply_14["__superclass_Prelude.Functor_0"]())(Control_Apply.lift2(Data_Either.applyEither)(Prelude["$"]))(_314))(_315));
        };
    });
};
    ...
    return new Prelude.Bind(function () {
        ...
        return function (f) {
            return ErrorT(Prelude.bind(__dict_Monad_13["__superclass_Prelude.Bind_1"]())(runErrorT(m))(function (_32) {
                ...
                throw new Error("Failed pattern match at bower_components/purescript-transformers/src/Control/Monad/Error/Trans.purs line 55, column 1 - line 62, column 1: " + [ _32.constructor.name ]);
            }));
        };
    });
};
            ...
            return Prelude["<<<"](Prelude.semigroupoidFn)(ErrorT)(Control_Monad_Rec_Class.tailRecM(__dict_MonadRec_4)(function (a) {
                return Prelude.bind((__dict_MonadRec_4["__superclass_Prelude.Monad_0"]())["__superclass_Prelude.Bind_1"]())(runErrorT(f(a)))(function (_33) {
                    return Prelude["return"]((__dict_MonadRec_4["__superclass_Prelude.Monad_0"]())["__superclass_Prelude.Applicative_0"]())((function () {
                        ...
                        throw new Error("Failed pattern match at bower_components/purescript-transformers/src/Control/Monad/Error/Trans.purs line 64, column 1 - line 72, column 1: " + [ _33.constructor.name ]);
                    })());
                });
            }));
        });
