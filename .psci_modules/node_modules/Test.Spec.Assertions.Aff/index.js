...
var expectError = function (a) {
    return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Aff.attempt(a))(function (_54) {
        ...
        throw new Error("Failed pattern match at bower_components/purescript-spec/src/Test/Spec/Assertions/Aff.purs line 13, column 1 - line 14, column 1: " + [ _54.constructor.name ]);
    });
};
module.exports = {
